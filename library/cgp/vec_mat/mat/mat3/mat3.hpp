...
#include "cgp/containers/matrix_stack/matrix_stack.hpp"
...
namespace cgp
{
    ...
    **/
    ...
    struct matrix_stack<float, 3, 3>
    {
        ...
        buffer_stack< buffer_stack<float, 3>, 3> data;

        // ******************************************************* //
        //  Constructors
        // ******************************************************* //
        matrix_stack();
        matrix_stack(buffer_stack< vec3, 3> const& elements);
        matrix_stack(vec3 const& row_1, vec3 const& row_2, vec3 const& row_3);
        matrix_stack(buffer_stack<float, 9> const& elements);
        matrix_stack(
